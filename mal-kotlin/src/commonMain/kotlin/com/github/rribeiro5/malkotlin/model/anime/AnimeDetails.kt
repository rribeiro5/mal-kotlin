...
import com.github.rribeiro5.malkotlin.model.manga.RelatedMangaNode
...
data class AnimeDetails(
    ...
    val relatedAnime: List<RelatedAnimeNode>?,
    @SerialName("related_manga")
    val relatedManga: List<RelatedMangaNode>?,
    val recommendations: List<AnimeRecommendationNode>?,
